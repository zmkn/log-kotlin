...
class Logger private constructor(private val config: Config) {
    ...
    fun trace(stackOffset: Int, vararg messages: Any?) = print(Level.TRACE, stackOffset, *messages)
    fun trace(vararg messages: Any?) = print(Level.TRACE, *messages)
    fun trace(stackOffset: Int, message: () -> Any?) = print(Level.TRACE, stackOffset, message)
    fun trace(message: () -> Any?) = print(Level.TRACE, message)

    fun debug(stackOffset: Int, vararg messages: Any?) = print(Level.DEBUG, stackOffset, *messages)
    fun debug(vararg messages: Any?) = print(Level.DEBUG, *messages)
    fun debug(stackOffset: Int, message: () -> Any?) = print(Level.DEBUG, stackOffset, message)
    fun debug(message: () -> Any?) = print(Level.DEBUG, message)

    fun info(stackOffset: Int, vararg messages: Any?) = print(Level.INFO, stackOffset, *messages)
    fun info(vararg messages: Any?) = print(Level.INFO, *messages)
    fun info(stackOffset: Int, message: () -> Any?) = print(Level.INFO, stackOffset, message)
    fun info(message: () -> Any?) = print(Level.INFO, message)

    fun warn(stackOffset: Int, vararg messages: Any?) = print(Level.WARN, stackOffset, *messages)
    fun warn(vararg messages: Any?) = print(Level.WARN, *messages)
    fun warn(stackOffset: Int, message: () -> Any?) = print(Level.WARN, stackOffset, message)
    fun warn(message: () -> Any?) = print(Level.WARN, message)

    fun error(stackOffset: Int, vararg messages: Any?) = print(Level.ERROR, stackOffset, *messages)
    fun error(vararg messages: Any?) = print(Level.ERROR, *messages)
    fun error(stackOffset: Int, message: () -> Any?) = print(Level.ERROR, stackOffset, message)
    fun error(message: () -> Any?) = print(Level.ERROR, message)
