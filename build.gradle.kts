...
val projectInfo = mapOf(
    "logger-kotlin" to mapOf(
        "name" to "Kotlin Logger",
        "description" to "Logger from Zmkn",
        "tags" to listOf("kotlin", "logger")
    ),
)
            ...
            publications {
                create<MavenPublication>("mavenJava") {
                    ...
                    pom {
                        ...
                        url.set("https://github.com/zmkn/log-kotlin")
                        inceptionYear.set("2025")
                        licenses {
                            license {
                                name.set("MIT License")
                                url.set("https://github.com/zmkn/log-kotlin/blob/master/LICENSE")
                            }
                        }
                        developers {
                            developer {
                        ...
                        scm {
                            connection.set("scm:git:https://github.com/zmkn/log-kotlin.git")
                            developerConnection.set("scm:git:git@github.com:zmkn/log-kotlin.git")
                            url.set("https://github.com/zmkn/log-kotlin")
                        }
                    }
                }
    ...
    if (localProperties.getProperty("jreleaser.enable") == "true" && project.name != rootProject.name) {
        ...
        configure<JReleaserExtension> {
            ...
            project {
                ...
                links {
                    homepage.set("https://github.com/zmkn/log-kotlin")
                    documentation.set("https://github.com/zmkn/log-kotlin/wiki")
                    license.set("https://github.com/zmkn/log-kotlin/blob/master/LICENSE")
                    bugTracker.set("https://github.com/zmkn/log-kotlin/issues")
                    donation.set("https://github.com/zmkn/log-kotlin")
                }
            }
            signing {
                ...
                maven {
                    github {
                        create("github") {
                            ...
                            url.set("https://maven.pkg.github.com/zmkn/log-kotlin")
